...
define('BOT_TOKEN', '240021235:AAFeMabQcgh9pAGXjXXlUv7V0z7qCepr63E');
...
به عنوان مثال :
`123456789:ABCDE1FGGHO5KLMNO5PLRS`


به ربات ما امتیاز بدید  👈        [⭐️PayamResanSaz⭐️](https://telegram.me/storebot?start=PayamResanSaz_Bot)

🔹هر نفر = یک ربات ✖️
🔸ربات دوم = 3000تومان️
🤖 @PayamResanSaz_Bot',"parse_mode"=>"MARKDOWN","disable_web_page_preview"=>"true"));
...
";
      ...
      apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "<b>PayamResanSaz_Bot</b>
<b>ver. 2.0</b>
<code>Coded By</code> @XxattackerxX
...
🗣پیام ارسال شد");
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url=https://xosaz-resanmmm.rhcloud.com/'.$chat_id.'/pvresan.php');
apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "🚀 ربات شما با مـوفقیت آپدیت شد ♻️"));


    }
    }
    else if ($matches[0] != "/update"&& $matches[1]==""&&$chat_id != 1045980711) {
      if (strpos($text, ":")) {
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=https://xosaz-resanmmm.rhcloud.com/'.$chat_id.'/pvresan.php');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀
برای ورود به ربات خود کلیک کنید 👇😃
به ربات ما امتیاز بدید  👇
 https://telegram.me/storebot?start=PayamResanSaz_Bot
.";

    $bot_url    = "https://api.telegram.org/240021235:AAFeMabQcgh9pAGXjXXlUv7V0z7qCepr63E/";
...
🚀 @XxattackerxX"));
        ...
        }else if ($matches[0] != "/update"&&$matches[1] != ""&&$matches[2] != ""&&$chat_id == 1045980711) {
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[0].'/setwebhook?url=https://xosaz-resanmmm.rhcloud.com/'.$id.'/pvresan.php');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀
برای ورود به ربات خود کلیک کنید 👇😃
به ربات ما امتیاز بدید  👇
 https://telegram.me/storebot?start=PayamResanSaz_Bot
.";
    ...
    $bot_url    = "https://api.telegram.org/bot240021235:AAFeMabQcgh9pAGXjXXlUv7V0z7qCepr63E/";
    $url        = $bot_url . "sendMessage?chat_id=" . $chat_id ;
